...
const buildTestSupportTree = memoize(function buildTestSupportTree() {
  // Manually invoke the child addons addon-test-support trees.
  let childAddonsAddonTestSupportTrees = this.nonDuplicatedAddonInvoke('treeFor', [
    'addon-test-support',
...
const buildCompleteJSTree = memoize(function buildCompleteJSTree() {
  ...
  return mergeTrees([vendorJSTree, engineAppTree, testSupportTree], { overwrite: true });
});
  ...
  extend(options) {
    ...
    options.init = function() {
      ...
      this.treeForPublic = function() {
        ...
        var testSupportTree = buildTestSupportTree.call(this);
